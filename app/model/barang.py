...
class Barang(db.Model):
    ...
    idkategori = db.Column(db.BigInteger, db.ForeignKey('tbl_barang_kategori.idkategori'), default="0", server_default="0")
    parent = db.relationship("BarangKategori", back_populates="children")

    idsatuan = db.Column(db.BigInteger, db.ForeignKey('tbl_barang_satuan.idsatuan'), default="0", server_default="0")
